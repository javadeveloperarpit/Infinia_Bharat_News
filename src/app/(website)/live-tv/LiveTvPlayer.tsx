...
export default function LiveTvPlayer({
  ...
  const playerUrl = youtubeId
    ? `https://www.youtube.com/embed/${youtubeId}?autoplay=1&mute=${
        muted ? 1 : 0
      }&controls=0&rel=0&modestbranding=1&playsinline=1&iv_load_policy=3&disablekb=1&fs=0`
    : "";
  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#f4f4f5] text-zinc-900">
      ...
      <header className="sticky top-0 z-40 border-b border-zinc-200 bg-white">
        <div className="mx-auto flex h-[66px] max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex shrink-0 items-center gap-2 border border-red-200 bg-red-50 px-3 py-2 sm:px-4">
