              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full border border-zinc-200 bg-white shadow-sm">
                  ...
                  >
                    ...
                    <path
                      fill="#FBBC05"
                      d="M6.51 13.58A5.86 5.86 0 0 1 6.2 12c0-.55.1-1.08.31-1.58V7.89H3.27A9.74 9.74 0 0 0 2.25 12c0 1.57.38 3.05 1.02 4.11l3.24-2.53Z"
                    />
                    <path
                      fill="#EA4335"
              ...
              {loginLoading ? (
                ...
                <>
                  ...
                  >
                    ...
                    <path
                      fill="#FBBC05"
                      d="M6.51 13.58A5.86 5.86 0 0 1 6.2 12c0-.55.1-1.08.31-1.58V7.89H3.27A9.74 9.74 0 0 0 2.25 12c0 1.57.38 3.05 1.02 4.11l3.24-2.53 3.24Z"
                    />
                    <path
                      fill="#EA4335"
                      d="M12 6.38c1.43 0 2.71.49 3.72 1.46l2.79-2.79C16.84 3.49 14.63 2.5 12 2.5a9.75 9.75 0 0 0-8.73 5.39l3.24 2.53C7.29 8.1 9.45 6.38 12 6.38Z"
